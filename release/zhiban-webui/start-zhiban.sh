...
find_python() {
    echo ""
    echo -e "${YELLOW}[2/5]${NC} 查找 Python 3.12+..."
    ...
    echo ""
    echo -e "${YELLOW}请安装 Python 3.12 或更新版本:${NC}"
    echo ""
    echo -e "  方法1 (推荐): ${CYAN}brew install python@3.14${NC}"
    echo -e "  方法2: 从 ${CYAN}https://www.python.org/downloads/${NC} 下载"
    echo ""
    echo -e "安装后重新运行此脚本即可。"
    exit 1
}
